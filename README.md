...
| POST/api/question/new | This fetch is sent when a user posts a new question. It returns the users manage questions page with the new posted question | {'id': INT, 'username':STRING, 'email':STRING |
| POST/api/question/update/:questionId | This fetch is sent to update a question of the user. It returns the the updated question displayed on the manage questions page. | {'id': INT, 'username':STRING, 'email':STRING |
